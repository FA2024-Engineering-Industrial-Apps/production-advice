...
# Generating Combinations
    min_g = find_first_combination(number_of_data, pcb_list, pcb_data_dict, material_catalogue_dict, C_max)     # finding minimum possible number of groups in a valid combination in parallel
    best_combinations = []        # initialize a list to store the best combinations
    for combination in generate_combinations(pcb_list, pcb_data_dict, material_catalogue_dict, C_max,min_groups=[float(min_g)]):
